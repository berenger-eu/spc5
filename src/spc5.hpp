...
inline void SPC5_1rVc_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_1rVc_WT);
    core_SPC5_1rVc_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
...
inline void SPC5_1rVc_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_1rVc_WT);
    core_SPC5_1rVc_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_1rVc_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_1rVc_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_2rV2c_wt_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_2rV2c_WT);
    core_SPC5_2rV2c_wt_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
inline void SPC5_2rV2c_wt_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_2rV2c_WT);
    core_SPC5_2rV2c_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_2rV2c_wt_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_2rV2c_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_2rV2c_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_2rV2c);
    core_SPC5_2rV2c_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_2rV2c_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_2rVc_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_2rVc);
    core_SPC5_2rVc_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
inline void SPC5_2rVc_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_2rVc);
    core_SPC5_2rVc_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_2rVc_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_2rVc_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_4rV2c_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_4rV2c);
    core_SPC5_4rV2c_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
inline void SPC5_4rV2c_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_4rV2c);
    core_SPC5_4rV2c_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_4rV2c_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_4rV2c_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_4rVc_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_4rVc);
    core_SPC5_4rVc_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
inline void SPC5_4rVc_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_4rVc);
    core_SPC5_4rVc_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_4rVc_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_4rVc_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
inline void SPC5_8rV2c_Spmv<double>(const SPC5Mat<double>& mat, const double x[], double y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_8rV2c);
    core_SPC5_8rV2c_Spmv_asm_double(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
inline void SPC5_8rV2c_Spmv<float>(const SPC5Mat<float>& mat, const float x[], float y[]){
    assert(mat.format == SPC5_MATRIX_TYPE::FORMAT_8rV2c);
    core_SPC5_8rV2c_Spmv_asm_float(mat.numberOfRows, mat.rowsSize.get(),
                                   mat.blocksColumnIndexesWithMasks.get(), mat.values.get(),
                                   x, y);
}
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_8rV2c_Spmv_asm_double(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
...
#pragma omp parallel num_threads(numThreads)
    {
        ...
        core_SPC5_8rV2c_Spmv_asm_float(threadsVecs[omp_get_thread_num()].numberOfRows,
                                       threadsVecs[omp_get_thread_num()].threadRowsSize.get(),
                                       threadsVecs[omp_get_thread_num()].threadBlocksColumnIndexesWithMasks.get(),
                                       threadsVecs[omp_get_thread_num()].threadValues.get(),
                                       x, threadsVecs[omp_get_thread_num()].threadY.get());
