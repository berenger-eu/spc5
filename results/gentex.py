...
##############################################################
facto_column_name = 'facto_column_name'
if facto_column_name in df.columns:
    print(f"Column '{facto_column_name}' exists.")
    print('====================================================')
    print('====================================================')
    print('compare facto or not')
    print('====================================================')
    print('====================================================')
    ...
    for hsum in hsumtypes:
        ...
        for i, row in df.iterrows():
            ...
            if 'CO' in matrixname or 'dense' in matrixname or 'nd6k' in matrixname:
                matrixname=matrixname.replace('_', ' ')
                types = row['type']
                facto = 'full x load' if row[facto_column_name] == 'Facto' else 'partial x load'
                
                matrixnamewithtype = matrixname + ' ' + facto + ' (f64)' if types == 'double' else matrixname + ' ' + facto + ' (f32)'
